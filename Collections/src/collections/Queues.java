...
/*******************************************************************************
* Queues are basically "waiting lines" for objects and are treated using FIFO
* (First In-First Out) methodology. The first in is the first out, like a line
* at a supermarket or an airline.
 ******************************************************************************/
